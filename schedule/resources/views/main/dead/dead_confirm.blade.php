...
<body class="eve">
  <section class="top_title">
    <div class="title">
      <h1><span class="left_ball">●</span><img src="/img/main_img/check.png" width="60" height="60">登録内容確認<span class="right_ball">●</span></h1>
    </div>
    <div class="red"></div>
  </section>

  <section class="register_container">
    <form action="{{ route('dead_complete') }}" method="POST">
      @csrf
      <div class="background_form">
        <h2>下記の内容で登録してよろしいですか？</h2>
          ...
          <div class="default_form">
            <h1>2</h1>
            <div class="form_contents confirm_contents">
              <div class="content">
                <label>日付</label><br>
                @if($day2) 
                <p>{{ $day2 }}</p><br>
