...
<body class="eve">
  <section class="top_title">
    <div class="title">
      <h1><span class="left_ball">●</span><img src="/img/main_img/check.png" width="60" height="60">期限登録<span class="right_ball">●</span></h1>
    </div>
    <div class="red"></div>
  </section>

  <section class="register_container">
    <form action="{{ route('dead_schedule') }}" method="POST" class="background_form">
    @csrf
