...
<body class="pm">
  <section class="top_title">
    <div class="title">
      <h1><span class="left_ball">●</span><img src="/img/main_img/moon.png" width="60" height="60">予定登録<span class="right_ball">●</span></h1>
    </div>
    <div class="red"></div>
  </section>

  <section class="register_container">
    <form action="{{ route('pm_schedule') }}" method="POST" class="background_form">
    @csrf
