...
<body class="pm">
  <section class="top_title">
    <div class="title">
      <h1><span class="left_ball">●</span><img src="/img/main_img/moon.png" width="60" height="60">予定変更<span class="right_ball">●</span></h1>
    </div>
    <div class="red"></div>
  </section>

  <section class="edit_choice_form">
    <form action="{{ route('pm_edit_input') }}" method="POST" class="background_form">
    @csrf
      <div class="edit_form">
        <input type="hidden" name="pm_id" value="{{ old('pm_id', $edit_schedule->id) }}">
        <h1>下記の内容で登録します。</h1>
        ...
        <div class="edit_link">
          <a href="pm_edit_choice">日付選択に戻る</P>
        </div>
      </div>
    </form>
  </section>
