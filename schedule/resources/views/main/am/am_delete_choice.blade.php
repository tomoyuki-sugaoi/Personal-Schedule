...
<body class="am">
  <section class="top_title">
    <div class="title">
      <h1><span class="left_ball">●</span><img src="/img/main_img/sun.png" width="80" height="60">予定削除<span class="right_ball">●</span></h1>
    </div>
    <div class="red"></div>
  </section>

  <section class="register_container">
    <form action="{{ route('am_delete_choice') }}" method="POST" class="delete_container background_form">
    @csrf
